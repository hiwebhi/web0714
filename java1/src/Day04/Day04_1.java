...
public class Day04_1 {
	...
	public static void main(String[] args) {
		...
		// 과제12: 4개의 값을 입력받아 내림차순 출력
				...
				System.out.println("내림차순: "+정수1 +정수2 +정수3 +정수4 );
				
		
		
		
		//문제1: *로그인 페이지[아이디:admin 비밀번호=1234]
		//1.아이디와 비밀번호를 입력받아 동일한 경우는 로그인 성공 출력
		System.out.println("[[로그인 페이지]]");
		System.out.println("[[회웡 아이디 :");String id=scanner.next();
		System.out.println("[[회원 비밀번호 :"); int password=scanner.nextInt();
		//로그인 처리
		if (id.equals("admin")) {//문자열[클래스]은 비교연산자 사용할 수 없다
			                     //String 클래스 비교 메소드: 문자열.equals("비교대상")=>결과: true/false
			
			// 아이디가 동일한 경우 + 비밀번호가 동일한경우
