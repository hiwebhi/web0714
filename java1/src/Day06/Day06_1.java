...
public static void main(String[] args) {
	...
	//재어문:if [논리제어], switch[값제어]
	//반복문:for, while, do~while
		//break;continue;
	
	//switch
		//형태:switch(key:검사대상){case:검사 :실행문}
		//1.(key) 에 해당하는 case 찾은후 아래 case를 모두 실행
	...
	///////////////////////////////////////////////////
	if(점수==90) System.out.println("90점 입니다.");
	else if(점수==80) System.out.println("80점 입니다.");
	else if(점수==70) System.out.println("70점 입니다.");
	...
	//예3) 세 점수의 평균이 90점 이상이면 'A' 80점 이상이면 'B' 나머지 탈락
	int 국어=80, 영어=80, 수학=100;
	int 평균=(국어+영어+수학)/3;
	System.out.println(평균/10);
			//87/10=>8.7
	switch(평균/10) {
