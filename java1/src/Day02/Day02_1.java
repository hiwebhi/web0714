...
public class Day02_1 { // c s
	...
	//용량단위
	    //1bit : 0 혹은 1
        //1bit => 8bit [01010101] => 1 byte [메모리 기본단위]
...
public static void main(String[] args) { //m s
	...
	// 변수 : 데이터 저장하는 상자
	  ...
	  //자료형: 메모리의 크기를 미리 정해진 형태
	     //왜 : 메모리 효율적으로 사용하자 [메모리 용량 증가===> 속도감소 ]
...
//용량단위	
	...
	//2. 자료형
	   ...
	   // boolean 논리변수2=10;   // 상자의 크기가 작기 때문에 오류
	    ...
	    char 문자변수 = 'a';
	    System.out.println("문자 변수 값은 :" + 문자변수);
	    char 문자변수2 = 97;
        ...
        float 실수변수1= 10.51111111111f; //데이터 f
        System.out.println("실수변수 값은"+실수변수1);
        
	    //8. double : 8byte [ ] :실수의 기본타입 /소수점 15자리
