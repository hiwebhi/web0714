...
public class Board {
		...
		//2.생성자
			...
			//2. 모든 필드를 받는 생성자[ 오른쪽 클릭=>source=>generated constructor ]
		...
		//3.메소드:
			    		...
			    		for(int i=0;i<Day08_2_Start.boardlist.length;i++) {
			    			if(Day08_2_Start.boardlist[i]==null) {
			    				...
			    				//2.첫번째 게시물이 아닌경우는 마지막 게시물의 +1
			    					...
			    					bno=Day08_2_Start.boardlist[i-1].bno+1; break; //마지막 게시물의 번호 +1
			...
			public void bview(int bno) {//인수o
				...
				Board board=Day08_2_Start.boardlist[index]; //찾은 게시물 위치의 게시물 가져오기	
